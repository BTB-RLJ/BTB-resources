...
jags_model <- jags.model(file = "Ch14-Cowabortion.jags", data = data,
...
### Now stan
stan_fit <- stan(file = 'Ch14-Cowabortion.stan', data = data, chains = 3,
                 init = inits, iter=(ndraws+burnin), warmup=burnin,
                 pars=c('gamma', 'theta', 'prob'), include=FALSE) # Do not save "gamma," "theta," or "prob" vectors
