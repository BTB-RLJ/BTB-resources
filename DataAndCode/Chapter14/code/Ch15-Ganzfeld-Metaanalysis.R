...
jags_model <- jags.model(file = "Ch15-Ganzfeld-Metaanalysis.txt", data = data, n.chains = 3, inits = inits)
...
### Now stan
stan_fit <- stan(file = 'Ch15-Ganzfeld-Metaanalysis.stan', data = data, chains = 3, 
